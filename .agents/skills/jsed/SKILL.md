...
2. `packages/jsed/docs/architecture.md` — the dependency narrative, from JsedDocument up through Editor
3. `packages/jsed/docs/vocabulary.md` — domain terms (FOCUSABLE, TOKEN, LINE, etc.)
